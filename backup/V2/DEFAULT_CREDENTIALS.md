...
### 5. Login:
- Use **admin/REDACTED_ROTATED_SECRET** for admin access
- Use **trader1/REDACTED_ROTATED_SECRET** for user testing
...
{
  "currentPassword": "REDACTED_ROTATED_SECRET",
...
### "Invalid password"?
- Default password is case-sensitive: `REDACTED_ROTATED_SECRET`
