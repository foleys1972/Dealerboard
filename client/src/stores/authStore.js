    ...
    (set, get) => ({
      ...
      login: async (credentials) => {
        ...
        try {
          ...
          try {
            ...
            await routingService.initialize(user);
            console.log('✅ Client routing initialized with homeserver:', user.matrixHomeserver?.serverName);
          } catch (error) {
            console.warn('Failed to initialize client routing:', error);
          }
      ...
      refreshUser: async () => {
        ...
        try {
          ...
          // Update client routing if homeserver changed
          try {
            const routingService = getClientRoutingService();
            await routingService.initialize(user);
          } catch (error) {
            console.warn('Failed to update client routing:', error);
          }
