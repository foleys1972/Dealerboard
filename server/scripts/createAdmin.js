...
async function createAdmin() {
  try {
    ...
    // Create admin user
    const adminPassword = 'REDACTED_ROTATED_SECRET'; // Default password - CHANGE IN PRODUCTION!
    ...
    console.log('═══════════════════════════════════');
    console.log('Username: admin');
    console.log('Password: REDACTED_ROTATED_SECRET');
    console.log('═══════════════════════════════════');
    console.log('');
    ...
    const testUserPassword = 'REDACTED_ROTATED_SECRET';
